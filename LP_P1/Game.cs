...
namespace LP_P1
{
    class Game
    {
        ...
        public Game(string str)
        {
            ...
            supportURL =                new Uri(data[21]);
            aboutText =                 data[22];
            headerImage =               new Uri(data[23]);
            website.TryCreate(website,data[24], website);
        }
        ...
        public void PrintAllValues()
        {
            ...
            Console.WriteLine(supportURL.ToString());
            Console.WriteLine(aboutText);
            Console.WriteLine(headerImage.ToString());
